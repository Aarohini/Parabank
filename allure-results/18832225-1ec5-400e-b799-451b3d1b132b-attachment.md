...
- Name: api.spec.ts >> Accounts API Tests >> TC-NEG-API-02: @api Invalid Customer ID
- Location: tests\api.spec.ts:99:13

# Error details

```
Error: apiRequestContext.post: connect ETIMEDOUT 2606:4700:8d97:eeff:afd9:54b:f8d3:a77:443
Call log:
  - → POST https://parabank.parasoft.com/parabank/services/bank/createAccount?customerId=999999&newAccountType=0&fromAccountId=20115
